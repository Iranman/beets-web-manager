...
class ReplacementRetryPipelineTests(unittest.TestCase):
    ...
    def test_recording_id_without_internal_album_id_can_build_payload(self):
        ...
        self.assertIn('composite_workflows.find_all_items_by_mbid(mb_trackid)', verifier_source)
    ...
    def test_verifier_checks_imported_rows_outside_original_album(self):
        ...
        self.assertIn('composite_workflows.find_all_items_by_mbid(mb_trackid)', verifier_source)
        self.assertIn('composite_workflows.find_all_items_by_album_id(album_id)', verifier_source)
        self.assertIn('composite_workflows.get_items_page(offset=0, limit=100)', verifier_source)
