...
* **Cause**: Compose is attempting to pull a local-only image name (e.g. `beets-web-manager:0.1.15`) from Docker Hub instead of using the published GitHub Container Registry image.
